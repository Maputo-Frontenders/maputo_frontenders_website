...
export const Event = () => {
  return (
    <section className="bg-mf-dark text-mf-white space-y-8 py-10 flex justify-center items-center flex-col">
      ...
      <div className="flex justify-between gap-4">
        {events.map((item) => (
          <div className="bg-mf-least rounded-md max-w-80 overflow-hidden flex flex-col gap-4">
